...
import type { AgentRecord, AgentStats, RegistryEvent, RegistryEventType } from "../types.ts";
...
export class AgentRegistry {
	...
	startPolling(): void {
		...
		console.log(
			`Started agent registry polling for posse "${this.posseName}" every ${this.pollInterval}ms`,
		);
	}
 ...
 */
export async function createAndInitializeRegistry(config: RegistryConfig): Promise<AgentRegistry> {
