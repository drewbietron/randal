...
import type { AgentRecord, TaskEvent, RegistryEvent, RegistryEventType } from '../types.ts';
...
export class DashboardWebSocket {
	 ...
	 */
	constructor(httpServer: HttpServer, registry: AgentRegistry, options: WebSocketGatewayOptions = {}) {
