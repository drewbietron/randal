...
import type { TaskRouter, ChatRequest } from '../types.ts';
		...
		getAllAgents: () => [
			{
				...
				version: '0.1.0',
				metadata: {},
				health: { status: 'healthy', lastSeen: new Date().toISOString(), isResponsive: true, msSinceLastHeartbeat: 1000 },
			},
			{
				id: 'agent-2',
				name: 'agent-2',
				...
				version: '0.1.0',
				metadata: {},
				health: { status: 'busy', lastSeen: new Date().toISOString(), isResponsive: true, msSinceLastHeartbeat: 1000 },
			},
		],
